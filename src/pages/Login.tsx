...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[hsl(145,60%,96%)] p-4">
      {/* Header */}
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-[hsl(160,84%,39%)]">
          Ferme Diallo
        </h1>
        <p className="text-[hsl(160,84%,39%)] mt-2">
      ...
      <div className="w-full max-w-md bg-card rounded-3xl p-8 shadow-lg border border-border/30 animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex justify-end">
            <button 
              type="button" 
              className="text-[hsl(160,84%,39%)] text-sm hover:underline"
            >
              Mot de passe oublié ?
            </button>
          </div>
          ...
          <Button
            type="submit"
            className="w-full h-12 rounded-xl font-semibold bg-[hsl(160,84%,39%)] hover:bg-[hsl(160,84%,35%)] text-white btn-press"
            disabled={isLoading}
          >
            {isLoading ? (
        ...
        <div className="flex items-center gap-4 my-6">
          ...
          <span className="text-muted-foreground text-sm">Ou continuer avec</span>
          <div className="flex-1 h-px bg-border" />
        </div>
        ...
        <p className="text-center mt-6 text-muted-foreground">
          ...
          <button className="text-[hsl(160,84%,39%)] font-semibold hover:underline">
            Créer un compte
          </button>
        </p>
